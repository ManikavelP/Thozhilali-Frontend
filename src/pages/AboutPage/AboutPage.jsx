        ...
        <div className='flex sm:flex-row flex-col  w-full h-full   items-center justify-between '>
          <div className='sm:w-[40%] w-full h-full flex flex-col order-2  sm:order-1 items-center justify-center '>
            ...
            <div className='w-[70%] h-[50%] flex flex-col   bg-backGround'>
              ...
              <p className='text-sm text-gray-300'>We improve people’s lives by connecting them to meaningful work</p>
            </div>
      ...
      <div className='mt-[15%] w-full sm:h-[55%] h-[100%]  flex sm:items-start items-center  flex-col '>
       <div  className='sm:w-[50%] w-[80%]  h-full flex flex-col sm:items-start items-center  sm:ml-24 '>
        <div className='mb-10  w-full'>
          <h1 className='text-4xl font-semibold '> We are AI-Powered talent acquisition automation platform</h1>
        </div>
        <div className='flex flex-col font-medium '>
          <p className='mb-3'>Over the years, recruitment presented many challenges.</p>
          <p className='mb-3'>The difficulty of finding the right set of skills, the inability to properly leverage data, the looming global talent gap issue, and the sheer amount of effort that goes into traditional recruitment.</p>
          <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptas, quam. Magni asperiores ipsa aut repellat, voluptas ratione non eum alias corporis, suscipit necessitatibus quod consequatur dolorem maxime impedit saepe quia.</p>
